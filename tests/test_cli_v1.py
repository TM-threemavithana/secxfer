...
CLI smoke tests via main() ΓÇö exercises the argument parsing and the
full sendΓåÆreceive pipeline through the CLI layer.
...
class TestSendReceive:
    ...
    def test_wrong_identity_exits_nonzero(self, alice_bob, tmp_path):
        """Receiving with wrong identity key ΓåÆ AuthenticationError ΓåÆ rc=1."""
        alice_dir, bob_dir = alice_bob
